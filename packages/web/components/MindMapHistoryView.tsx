              ...
              <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2">
                {filteredClusters.map((cluster) => (
                  <div
                    ...
                    className={`group relative bg-white dark:bg-[#18181b]/50 rounded-lg border transition-all duration-200 text-left overflow-hidden cursor-pointer ${'border-slate-200 dark:border-[#334155] hover:border-slate-300 dark:hover:border-[#64748b] hover:shadow-sm'}`}
                  >
                    {/* Preview area */}
            ...
            {filteredClusters.map((cluster) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`text-[10px] text-slate-400 dark:text-[#64748b] transition-transform inline-block ${selectedTopic === cluster.topic ? 'rotate-180' : ''}`}
                  >
                    ▾
                  </span>
                </button>
                  ...
                  <div className="border-t border-slate-100 dark:border-[#334155] bg-slate-50/50 dark:bg-[#334155]/10">
                    {cluster.queries.map((query) => (
                      <div
                        ...
                        onMouseEnter={(e) => handleQueryMouseEnter(e, query)}
                        onMouseLeave={handleQueryMouseLeave}
                        className={`flex items-center gap-2 px-3 py-2 border-b border-slate-100 dark:border-[#334155] last:border-0 cursor-pointer transition-colors ${'hover:bg-white dark:hover:bg-[#334155]/20'}`}
                      >
                        <div
                        ...
                        />
                        <div className="flex-1 min-w-0">
                          <p className="text-[10px] text-slate-600 dark:text-[#94a3b8] truncate">
                            {query.query}
                          </p>
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 8, color: '#94a3b8' }}>
                {filteredClusters.find((c) => c.topic === clusterInsight.topic)?.queries.length ||
                  0}{' '}
                conversations
              </span>
            </div>
            <p
              style={{ fontSize: 9, color: '#64748b', lineHeight: 1.5, margin: 0, marginBottom: 8 }}
            >
              {clusterInsight.text}
            </p>
            <button
