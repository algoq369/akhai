                          ...
                          >
                            ...
                            >
                              <div className="flex items-center gap-2 mb-1">
                                <span className={`w-2 h-2 rounded-full ${config.dot}`} />
                                <span
                                  className={`text-[10px] font-semibold ${config.text} capitalize`}
                                >
                                  {insight.category}
                                </span>
                                    ...
                                    <div className="flex items-center gap-1.5 pt-2 border-t border-white/30">
                                      <button
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          window.open(
                                            `/?q=${encodeURIComponent(`Explore: ${insight.title}`)}`,
                                            '_blank'
                                          );
                                        }}
                        ...
                        {insights.slice(6, 10).map((insight, idx) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <span
                                  className={`text-[9px] ${config.text} ${isExpanded ? '' : 'line-clamp-1'}`}
                                >
                                  {insight.title}
                                </span>
...
export function shouldShowLayers(content: string, hasGnosticData: boolean = false): boolean {
  ...
  // Show for any structured content or any substantial response
