...
export default function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white border border-gray-200 rounded-md shadow-xl p-5 max-w-xs w-full mx-4 z-10 font-mono">
        <button
          onClick={onClose}
          className="absolute top-2 right-3 text-gray-400 hover:text-gray-600 transition-colors text-[10px]"
        >
          ✕
        </button>

        <h2 className="text-[11px] uppercase tracking-[0.1em] text-gray-500 mb-4">connect account</h2>
        ...
        {authMethod === null ? (
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded text-[10px] text-gray-600 bg-white hover:bg-gray-50 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGitHubLoading ? (
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full px-3 py-1.5 bg-gray-900 text-white rounded text-[10px] hover:bg-gray-800 transition-colors"
            >
              Sign & Connect
            </button>
            <button
              onClick={resetState}
              className="w-full px-3 py-1 text-[9px] text-gray-400 hover:text-gray-700 transition-colors"
            >
              Back
            </button>
          </div>
          ...
          <div className="space-y-2">
            ...
            <button
              onClick={resetState}
              className="w-full px-3 py-1.5 border border-gray-200 rounded text-[10px] text-gray-600 bg-white hover:bg-gray-50 transition-colors"
            >
              Back
            </button>
            <button
