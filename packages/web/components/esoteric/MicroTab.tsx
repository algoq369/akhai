    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        ...
        {chart ? (
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg p-3 flex items-center justify-center">
            <div className="text-center">
              <div className="text-[24px] text-zinc-400 dark:text-zinc-500 mb-2">{'\u260A'}</div>
      ...
      {chart ? (
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg p-4 text-center">
          <div className="text-[11px] text-zinc-400 italic">
            {mode === 'esoteric'
