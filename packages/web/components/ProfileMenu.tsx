...
import { walletBus } from '@/lib/wallet-bus';
...
export default function ProfileMenu({
  ...
  const disconnect = () => walletBus.disconnectWallet();
        ...
        <>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-[9px] text-slate-300 dark:text-slate-600 hover:text-slate-500 transition-colors"
              style={{ padding: '0 2px' }}
            >
              ✕
            </button>
          ...
          {showLanguageSelector && (
            ...
            >
              <div
                className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm p-6 max-w-sm"
                onClick={(e) => e.stopPropagation()}
              >
                <h3 className="text-lg font-mono text-slate-900 dark:text-slate-100 mb-4">
                  Select Language
                </h3>
