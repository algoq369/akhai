...
/**
 * LensView — structured 12-lens cognitive signature display.
 * Collapsed: 3-line preview with sigils. Expanded: full lens entries.
 */
...
export default function LensView({ signature }: LensViewProps) {
