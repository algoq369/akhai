    ...
    <div className="w-full h-full flex flex-col overflow-hidden bg-[#fafbfc] dark:bg-[#0a0a0a]">
      ...
      <div className="flex items-center justify-between px-4 py-1 bg-white dark:bg-[#111] border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center gap-3">
          <span className="text-[9px] font-medium text-slate-700 dark:text-slate-300" style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace" }}>
            knowledge graph
          </span>
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Zoom controls */}
          <button onClick={zoomOut} className="px-2 py-0.5 text-[9px] text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded">
            -
          </button>
          <span className="text-[9px] font-mono text-slate-500 dark:text-slate-400 w-10 text-center">
            {Math.round(zoom * 100)}%
          </span>
          <button onClick={zoomIn} className="px-2 py-0.5 text-[9px] text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded">
            +
          </button>
          <button onClick={fitView} className="px-2 py-0.5 text-[9px] text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded">
            fit
          </button>
        </div>
      </div>
          ...
          >
            <div className="bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden" style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace" }}>
              ...
              <div className="flex items-center justify-between px-3 py-1.5 bg-slate-50 border-b border-slate-100">
                ...
                <button onClick={closeAnalyse} className="p-1 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg">
              ...
              <div className="grid grid-cols-3 gap-px bg-slate-100">
                ...
                <div className="bg-white px-2 py-1.5 text-center">
                  ...
                  <div className="text-[7px] text-slate-400 uppercase tracking-wider">connections</div>
                </div>
                <div className="bg-white px-2 py-1.5 text-center">
              ...
              <div className="px-3 py-1.5 border-t border-slate-100">
                ...
                {analyseData.topConnections.length > 0 && (
                  <div className="space-y-1 mb-2">
                    <div className="text-[8px] text-slate-400 uppercase tracking-wider">top connections</div>
                    {analyseData.topConnections.slice(0, 3).map(conn => {
                      ...
                      return (
                        <div key={conn.id} className="flex items-center gap-1.5 text-[9px]">
                          <span style={{ width: 4, height: 4, borderRadius: '50%', background: cc.text }} className="inline-block flex-shrink-0" />
              ...
              {(aiLoading || aiInsight) && (
                <div className="px-3 py-1.5 border-t border-slate-100">
                  {aiLoading ? (
                    ...
                    <p className="text-[9px] text-slate-600 leading-relaxed" style={{ maxHeight: 48, overflow: 'hidden' }}>{aiInsight}</p>
                  )}
                </div>
              )}
