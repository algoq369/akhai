/**
 * Detection patterns for depth annotations — extracted from depth-annotations.ts
 */
...
const DETECTION_PATTERNS: DetectionPattern[] = [
  ...
  // DETAILS: Companies, products, AI models, platforms, technologies
  {
    ...
    extractor: (match, context) => {
      ...
      if (
        /transformer\s+(?:models?|architecture)|attention\s+mechanism|self-attention/i.test(term)
      ) {
        return {
          content:
