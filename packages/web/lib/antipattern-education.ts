/**
 * ANTIPATTERN EDUCATION & ACTIVATION DATA
 *
 * Extracted from antipattern-engine.ts.
 * Contains educational content for each antipattern type
 * and expected Layer activation patterns for correlation analysis.
 */

import { type AntipatternType } from './antipattern-guard';
...
// ═══════════════════════════════════════════════════════════════════════════
// EXPECTED ACTIVATIONS FOR CORRELATION
// ═══════════════════════════════════════════════════════════════════════════

export function getExpectedActivations(antipatternType: AntipatternType): Record<Layer, number> {
...
export function calculateActivationCorrelation(
