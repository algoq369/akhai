/**
 * LAYER PROCESSOR UTILITIES
 * Pure helper functions for layer activation, blending, and methodology suggestion.
 * Extracted from layer-processor.ts to keep files under 500 lines.
 */
...
export function getActiveLayers(config: TreeConfiguration): Layer[] {
...
export function selectAdaptiveMode(query: string, activeCount: number): 'weighted' | 'parallel' {
