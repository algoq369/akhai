          ...
          <div className="bg-relic-white dark:bg-relic-void/30 border border-relic-mist dark:border-relic-slate/30 p-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <p className="text-[11px] text-relic-silver leading-relaxed">
                  Rabbi Judah Loew created the Golem of Prague by inscribing EMET (אמת, "truth") on
                  its forehead. To deactivate it, he removed the first letter Aleph (א), leaving MET
                  (מת, "death").
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-[11px] text-relic-silver leading-relaxed">
                  AkhAI implements the same principle: AI can be instantly deactivated by removing
                  its "Aleph" - ensuring human oversight is always sovereign over machine autonomy.
                </p>
              </div>
            </div>
