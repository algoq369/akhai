  ...
  try {
    ...
    if (!posData || !posData.userId) {
      ...
      if (productType === 'credits') {
        await processLegacyCreditsPayment(
          invoiceId,
 ...
 */
async function processCreditsPayment(invoiceId: string, posData: PosData, amountUSD: number) {
 ...
 */
async function processSubscriptionPayment(invoiceId: string, posData: PosData, amountUSD: number) {
 ...
 */
async function processLegacySubscriptionPayment(invoiceId: string, description: string) {
