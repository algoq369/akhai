/**
 * Query processing logic extracted from route.ts
 */

import { queries, addQueryEvent, updateQueryStatus } from '@/lib/query-store';
...
export const METHODOLOGY_INSTRUCTIONS: Record<string, string> = {
