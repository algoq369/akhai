      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <div className="bg-white dark:bg-relic-void/50 border border-relic-mist dark:border-relic-slate/30 p-8 font-mono">
          ...
          <section className="mb-8">
            ...
            <div className="ml-4 space-y-2.5">
              ...
              <div className="flex items-center gap-4">
                ...
                <span
                  onClick={() =>
                    updateAppearance('showLayerOrigins', !settings.appearance.showLayerOrigins)
                  }
                  className="text-[9px] cursor-pointer hover:text-relic-void dark:hover:text-white transition-colors text-relic-slate dark:text-relic-ghost"
                >
                  [{settings.appearance.showLayerOrigins ? '●' : '○'}]{' '}
                  {settings.appearance.showLayerOrigins ? 'on' : 'off'}
                </span>
              </div>
            </div>
          </section>
                  ...
                  {(['auto', 'direct', 'cod', 'sc', 'react', 'pas', 'gtp'] as const).map(
                    (method) => (
                      <span
                        ...
                        style={{
                          color:
                            settings.methodology.defaultMethod === method
                              ? isDark
                                ? '#ffffff'
                                : '#18181b'
                              : '#94a3b8',
                ...
                <div className="flex items-center gap-5">
                  ...
                  {settings.features.depth && (
                    <div className="flex gap-2.5 items-center">
                      <span className="text-relic-silver dark:text-relic-ghost text-[9px]">
                        density:
                      </span>
                      {(['min', 'std', 'max'] as const).map((density) => (
                        <span
                          ...
                          style={{
                            color:
                              settings.features.depthDensity === density
                                ? isDark
                                  ? '#ffffff'
                                  : '#18181b'
                                : '#94a3b8',
          ...
          <section className="mb-8">
            ...
            <div className="ml-4 space-y-2.5">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-relic-void dark:text-white text-[9px] font-medium">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-relic-slate dark:text-relic-ghost text-[9px]">
          ...
          <div className="mt-12 pt-5 border-t border-relic-mist dark:border-relic-slate/30">
            ...
            <div className="text-relic-silver dark:text-relic-ghost text-[9px]">
